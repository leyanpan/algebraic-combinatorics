## TARGET AlgebraicCombinatorics.SubtractiveMethods.toSign_sq (theorem) — ELABORATED SIGNATURE
∀ (b : ZMod 2), AlgebraicCombinatorics.SubtractiveMethods.toSign b ^ 2 = 1

Docstring: The square of any sign is 1 
...
## INFORMAL STATEMENT
lem.cancel.toSign-sq

\leanhelper  For any $b \in \mathbb {Z}/2\mathbb {Z}$, we have $(\operatorname {toSign} b)^2 = 1$.
...
{
  "verdict": "faithful",
  "justification": "The target quantifies exactly over the stated domain, `\u2200 (b : ZMod 2)`, matching \u201cfor any b \u2208 \u2124/2\u2124,\u201d and concludes `toSign b ^ 2 = 1`, matching `(toSign b)^2 = 1`. The dependency defines `toSign : ZMod 2 \u2192 \u2124` by `if b = 0 then 1 else -1`, which agrees with the informal sign conversion `0 \u21a6 1, 1 \u21a6 -1`. The exponentiation and equality are therefore in \u2124, as intended, with no added hypotheses or restricted quantifiers."
}